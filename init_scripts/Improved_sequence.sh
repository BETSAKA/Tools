...
# Step 4: Install GDAL, GEOS, and PROJ libraries
...
# Step 5: Remove and reinstall 'sf' and 'terra' packages in R
...
# Step 6: Git clone the project repository
...
# Step 10: Update RStudio keyboard shortcuts
